...
unsigned int world::render::BlockTextureAtlas::attach(const io::File & file)
{
...
unsigned int world::render::BlockTextureAtlas::attach(ALLEGRO_BITMAP * bitmap)
{
	return attach(bitmap, false);
}
unsigned int world::render::BlockTextureAtlas::attach(ALLEGRO_BITMAP * bitmap, bool owned)
{
...
bool world::render::BlockTextureAtlas::build()
{
...
void world::render::BlockTextureAtlas::cleanup()
{
