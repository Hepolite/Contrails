...
void world::render::BlockRenderLoader::loadBlocks(const io::Folder & folder) const
{
...
void world::render::BlockRenderLoader::loadBlock(const io::File & file) const
{
...
void world::render::BlockRenderVariantLoader::loadVariant(const pugi::xml_node & variant)
{
...
void world::render::BlockRenderVariantLoader::loadModel(const pugi::xml_node & model)
{
...
void world::render::BlockRenderVariantLoader::loadTexture(const pugi::xml_node & texture)
{
	if (m_atlas == nullptr)
	{
...
void world::render::BlockRenderVariantLoader::loadOcclusion(const pugi::xml_node & occlusion)
{
