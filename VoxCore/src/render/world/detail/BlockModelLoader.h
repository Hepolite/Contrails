...
namespace render
{
	namespace world
	{
		...
		public:
			...
			void loadSide(const pugi::xml_node & node, const ::world::util::Side & side);
			void loadVertices(const pugi::xml_node & node, const ::world::util::Side & side);
			void loadIndices(const pugi::xml_node & node, const ::world::util::Side & side);
